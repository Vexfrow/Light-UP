...
public class DPLL{
        ...
        public boolean aModele; //si il ya un modele
        ...
        public static void main (String[] args) throws InterruptedException, IOException{
            ...
            time sat = new time("./Dimac.txt");
            int i = 0;
            sat.afficher("./save.txt", true, "");
        ...
        public DPLL ( int n2, int l2, int z2,boolean absurde2,String tab2[],int var2[], boolean aModele2, String[] isoles2 ){
            n = n2; 
            l = l2; 
            z = z2;
            absurde = absurde2;
        ...
        public boolean dpll () throws InterruptedException, IOException{
            ...
            if(this.absurde){ // l'ensemble des clauses contient une clause vide (soit une clause mise a 0 donc il ne peut pas y avoir de solution)
                ...
                if(!suppIsole() ){
                    afficher("./save.txt", true, "sans suppIsole");
                    if(!resUnitaire()){
                        afficher("./save.txt", true, "sans resUnitaire");
                        ...
                        afficher("./save.txt", true, "apres choix");
        ...
        //verifie si la clause *inclus est contenu dans la clause *dans
        public boolean  estContenu(int[] inclus, int[] dans){ 
            int l = inclus.length;
            int m = dans.length;
            int i = 0;
            int j = 0;
        ...
        public boolean resUnitaire(){
            ...
            int j = 0;
            int m = 0;
            while(j < this.n){ // On parcours le tableau
                String[] s = tab[i].split(" ");
                if(s.length == 1){
                    unit[m] = s[0];
                    m++;
            ...
            while(i < n){
                String[] s = tab[i].split(" "); // s est l'ensemble des litteraux de la clause
                sol = "";
                if(s.length == 1){

                    if( s[0].charAt(0) == '-'){
                        for(int k = 1; k < s[0].length(); k++){ // on prend la "valeur absolue de x"
                            sol = sol + s[0].charAt(k);
                        }
